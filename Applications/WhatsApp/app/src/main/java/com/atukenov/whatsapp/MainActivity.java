...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     *  Creates toolbar automatically by using class SectionsPagerAdapter
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);                             //My toolbar in activity_main.xml
        setSupportActionBar(toolbar);                                                       // set ActionBar
        // Create the adapter that will return a fragment for each of the three             // Adapter it is array with specific design in specific xml file
    ...
    /**
     * The choosen tab and calls placeholderFragment
     *
     */
    @Override
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         *
         * Choose some tab he goes to that tab
         */
